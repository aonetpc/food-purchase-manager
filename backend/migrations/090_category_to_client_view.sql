...
-- Step 2: 用关键词匹配方式把 203 项映射到新 8 类
...
-- Step 3: 检查是否还有旧分类残留（输出给运维看）
-- SELECT DISTINCT category FROM booking_checkup_items
-- WHERE category NOT IN ('基础体检','肝胆功能','心脑血管与血脂','糖代谢与肾功能','肿瘤标志物筛查','专项功能与系统','影像检查','性别专属');
-- 如果有残留，再手动添加精确匹配
