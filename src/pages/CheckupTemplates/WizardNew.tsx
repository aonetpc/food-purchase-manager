...
return (
  <div className="min-h-screen bg-gradient-to-b from-[#1f6b3e] via-green-50 to-[#faf7ee] pb-28">
    ...
    <main className="px-4 space-y-4 -mt-2">
      ...
      <section className="bg-white rounded-3xl p-4 shadow-sm">
        <div className="flex items-center gap-2 mb-3">
          <div className="w-7 h-7 rounded-full bg-[#0f5132] text-white flex items-center justify-center text-xs font-bold">1</div>
        ...
        <input
          ...
          maxLength={40}
          className="w-full h-12 px-4 rounded-xl bg-gray-50 border border-gray-200 focus:border-[#0f5132] focus:ring-2 focus:ring-emerald-100 outline-none text-sm"
          placeholder="如：画一2026体检套餐"
        />
      ...
      <section className="bg-white rounded-3xl p-4 shadow-sm">
        <div className="flex items-center gap-2 mb-3">
          <div className="w-7 h-7 rounded-full bg-[#0f5132] text-white flex items-center justify-center text-xs font-bold">2</div>
        ...
        <div className="mt-3 text-xs text-emerald-800 bg-blue-50 rounded-xl px-3 py-2">
              ...
              return (
                <button key={tpl.id} onClick={() => setBaseTemplateId(checked ? null : tpl.id)}
                  className={`w-full text-left rounded-2xl p-3 flex items-center gap-3 border-2 transition-all ${
                    checked ? 'border-[#0f5132] bg-emerald-50' : 'border-gray-100 bg-gray-50 hover:bg-gray-100'
                  }`}>
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#0f5132] to-green-700 text-white flex items-center justify-center text-xl flex-shrink-0">🎯</div>
                  ...
                  <div className={`w-5 h-5 rounded-full flex-shrink-0 flex items-center justify-center ${checked ? 'bg-[#0f5132] text-white' : 'border border-gray-300 bg-white'}`}>
