    ...
    >
      ...
      >
                              ...
                              <div className="max-h-[60vh] overflow-y-auto">
                                ...
                                {it.itemType === 'wellness' && (
                                  <div className="p-3 bg-lime-50 rounded-lg border border-lime-100">
                                    ...
                                    {/* feat/177: 康乐备注 */}
                                    {((it.extra as any).remark || (it.extra as any).placeholderNote) && (
                                      <div className="mt-2 p-2 bg-lime-50 rounded border border-lime-100">
                                        <div className="text-[11px] text-lime-600 font-semibold mb-1">📝 康乐备注</div>
                                        <div className="text-[12px] text-gray-700 bg-white rounded p-2 border border-lime-100">
                                          {(it.extra as any).remark || (it.extra as any).placeholderNote}
                                        </div>
                                      </div>
                                    )}
        ...
        <div className="flex gap-2 px-5 py-3 border-t border-gray-200 sticky bottom-0 bg-white flex-wrap">
          ...
          {(isAdmin || (canOperate && ['pending', 'sales_confirming', 'rejected'].includes(order.status))) && (
            <button
              type="button"
              onClick={onDelete}
